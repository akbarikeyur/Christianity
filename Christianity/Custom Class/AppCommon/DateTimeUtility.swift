...
func getTimeStringFromServerTimeStemp(_ timeStemp:Double) -> String{
    ...
    //dateFormatter.timeZone = TimeZone(abbreviation: "GMT") //Set timezone that you want
    //dateFormatter.locale = NSLocale.current
    dateFormatter.dateFormat = "dd/MM/yyyy hh:mm a"//DATE_FORMAT.DISPLAY_TIME_FORMAT
    return dateFormatter.string(from: date)
}
...
func getDateTimeStringFromServerTimeStemp(_ timeStemp:Double) -> String{
    ...
    //dateFormatter.timeZone = TimeZone(abbreviation: "GMT") //Set timezone that you want
    dateFormatter.locale = NSLocale.current
    dateFormatter.dateFormat = "dd/MM/yyyy hh:mm a" //DATE_FORMAT.DISPLAY_DATE_TIME_FORMAT
    return dateFormatter.string(from: date)
}
...
func getDateStringFromDate(date : Date) -> String
{
    ...
    //dateFormatter.timeZone = TimeZone(abbreviation: "GMT") //Set timezone that you want
    dateFormatter.locale = NSLocale.current
    dateFormatter.dateFormat = "dd/MM/yyyy hh:mm a"//DATE_FORMAT.SERVER_DATE_TIME_FORMAT
    return dateFormatter.string(from: date)
}
...
func getDateFromDateString(strDate : String) -> Date
{
   ...
   // dateFormatter.locale = NSLocale.current
    dateFormatter.dateFormat = "dd MMM yyyy HH:mm a"//DATE_FORMAT.DISPLAY_DATE_FORMAT
    return dateFormatter.date(from: strDate)!
}
...
func getTodayDateFromCurrentDate(_ date : Date) -> String
{
    let dateFormatter1 = DateFormatter()
    let date1 = date
