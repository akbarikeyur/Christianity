...
class LanguageManager: NSObject {
    ...
    override fileprivate init() {
        ...
        super.init()
        let english = CustomLocale(languageCode: GlobalConstants.englishCode, name: "United Kingdom")
        let finnish  = CustomLocale(languageCode: GlobalConstants.greekCode, name: "Greek")
